...
Repro: <https://github.com/ashi009/region-cache-repro>. (`-Znext-solver=globally` on nightly also scales per-impl on this shape — slower still, 1.9 s / 3.3 s — cause not investigated.)
